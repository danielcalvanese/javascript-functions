  ...
  describe("Finding living neighbors", () => {
    it("Should have a getLivingNeighbors function. @getLivingNeighbors-function", () => {
      ...
      assert.equal(rPentominoNeighborsOfFourThree.length, 4,
        "aHave you created a function 'getLivingNeighbors' that returns the living neighbors of the given cell?"
      );
      ...
      assert(
        ...
        "bHave you created a function 'getLivingNeighbors' that returns the living neighbors of the given cell?"
      );

      assert.equal(
        gameoflife.getLivingNeighbors([6, 6], rPentomino).length, 0,
        "cHave you created a function 'getLivingNeighbors' that returns the living neighbors of the given cell?"
      );
    });
  });
